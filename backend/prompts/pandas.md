...
5. STRICT SCHEMA ENFORCEMENT: ONLY use column names present in the provided schema. NEVER invent columns like 'JoiningDate', 'Join Year', 'Salary_USD', 'Joining' if they do not exist.
